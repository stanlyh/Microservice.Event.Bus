...
namespace Microservice.Event.Bus.Test.Abstractions
{
    /// <summary>
    /// Pruebas unitareas a la clase <see cref="Bus.Abstractions.EventBase"/>
    /// </summary>
    public class EventBaseTest
    {
        /// <summary>
        /// Valida que se genere automaticamente el identificador y la fecha del nuevo
        /// </summary>
        [Fact]
