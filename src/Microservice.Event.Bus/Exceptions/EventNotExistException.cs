...
{
    /// <summary>
    /// Se genera cuando se quiere acceder a un evento que no esta regstrado
    /// </summary>
    [Serializable]
    public class EventNotExistException : Exception
    {
        /// <summary>
        /// Crea una nueva instacia de <see cref="EventNotExistsException"
        /// </summary>
        public EventNotExistException() { }

        /// <summary>
        /// Crea una nueva instancia de <see cref="EventNotExistsException"
        /// </summary>
