...
namespace Microservice.Event.Bus.Abstractions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Microservice:Event.Bus.Abstractions.EventBase class
        /// </summary>
        protected EventBase()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the Microservice.Event.Bus.Abstrantions.EventBase class with a specified idEvent an createDate
        /// </summary>
